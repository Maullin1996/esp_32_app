...
class TanqueController extends StateNotifier<TanqueState> {
  TanqueController(this._getStatus, this._setManual, this._setRange, this._stop)
    : super(TanqueState.initial());

  final GetTanqueStatusUsecase _getStatus;
  final SetTanqueManualUsecase _setManual;
  final SetTanqueRangeUsecase _setRange;
  final StopTanqueUsecase _stop;
